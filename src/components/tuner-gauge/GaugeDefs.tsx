...
export function GaugeDefs({ bandOpacities }: GaugeDefsProps) {
    return (
        <defs>
            ...
            <mask id="arc-mask">
                <g opacity={bandOpacities.low} style={{ transition: 'opacity 0.3s ease-out' }}>
                ...
                <g opacity={bandOpacities.perfect} style={{ transition: 'opacity 0.3s ease-out' }}>
                ...
                <g opacity={bandOpacities.high} style={{ transition: 'opacity 0.3s ease-out' }}>
